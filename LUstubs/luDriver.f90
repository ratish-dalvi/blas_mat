...
!---------------------------------------------------------------------------------
! 
! Test of LU factorization (AKA Gaussian Elimination) with partial
...
! recompiling:
!   a. test correctness of LUmatmat/LUmatvec
...
! Last Modified: Mon 13 Oct 2014, 06:37 AM 
!---------------------------------------------------------------------------------
    ...
    blocksizes: do nb = blower, bupper, bstride
        ...
        matrixsizes: do n = nmin, nmax, skip
            ...
            timing_repetitions: do iters = 1, repetitions
                ...
                time = elapsedtime()
                call LUmatmat(A, nmax, n, ipiv, info, nb)
